(() => {
  ...
  const projects=[
    ...
    {title:'Professional CMS',tag:'02 · Content Platform',video:'Cms.mp4',poster:'Cms.jpg',cat:['fullstack','security'],desc:'A production-minded content management system with a self-hosted rich-text editor, post version control and an administrative audit trail.',points:['TinyMCE editor','Version control & restore','Media library','RBAC · CSRF · XSS prevention'],tech:['PHP','MySQL','JavaScript','AJAX','TinyMCE','Chart.js'],url:null},
